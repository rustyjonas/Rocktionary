...
import com.rocktionary.repository.ComentarCancionRepository;
...
public class ComentarCancionResourceIntTest {
    ...
    public void updateComentarCancion() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedComentarCancion are not directly saved in db
        em.detach(updatedComentarCancion);
