...
import com.rocktionary.domain.PuntuacionAlbum;
import com.rocktionary.repository.PuntuacionAlbumRepository;
...
public class PuntuacionAlbumResourceIntTest {
    ...
    public void updatePuntuacionAlbum() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedPuntuacionAlbum are not directly saved in db
        em.detach(updatedPuntuacionAlbum);
