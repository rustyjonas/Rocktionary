...
import com.rocktionary.repository.CancionRepository;
...
public class CancionResourceIntTest {
    ...
    public void updateCancion() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedCancion are not directly saved in db
        em.detach(updatedCancion);
        updatedCancion
