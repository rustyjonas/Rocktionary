...
import com.rocktionary.repository.DiscograficaRepository;
...
public class DiscograficaResourceIntTest {
    ...
    public void updateDiscografica() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedDiscografica are not directly saved in db
        em.detach(updatedDiscografica);
        updatedDiscografica
