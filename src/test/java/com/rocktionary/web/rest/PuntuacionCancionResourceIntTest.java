...
import com.rocktionary.domain.PuntuacionCancion;
import com.rocktionary.repository.PuntuacionCancionRepository;
...
public class PuntuacionCancionResourceIntTest {
    ...
    public void updatePuntuacionCancion() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedPuntuacionCancion are not directly saved in db
        em.detach(updatedPuntuacionCancion);
