...
public class BandaResourceIntTest {
    ...
    public void setup() {
        ...
        final BandaResource bandaResource = new BandaResource(bandaRepository, userRepository, puntuacionBandaRepository);
    ...
    public void updateBanda() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedBanda are not directly saved in db
        em.detach(updatedBanda);
        updatedBanda
