...
import com.rocktionary.domain.UserFollowingUser;
import com.rocktionary.repository.UserFollowingUserRepository;
...
public class UserFollowingUserResourceIntTest {
    ...
    public void updateUserFollowingUser() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedUserFollowingUser are not directly saved in db
        em.detach(updatedUserFollowingUser);
