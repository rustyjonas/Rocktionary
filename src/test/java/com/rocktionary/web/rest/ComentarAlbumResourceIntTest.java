...
//        assertThat(testComentarAlbum.getAlbumName()).isEqualTo(DEFAULT_ALBUM_NAME);
//    }
//
//    @Test
//    @Transactional
...
//    @Test
//    @Transactional
//    public void checkAlbumNameIsRequired() throws Exception {
//        int databaseSizeBeforeTest = comentarAlbumRepository.findAll().size();
//        // set the field null
//        comentarAlbum.setAlbumName(null);
//
//        // Create the ComentarAlbum, which fails.
//
//        restComentarAlbumMockMvc.perform(post("/api/comentar-albums")
//            .contentType(TestUtil.APPLICATION_JSON_UTF8)
//            .content(TestUtil.convertObjectToJsonBytes(comentarAlbum)))
...
//
//        List<ComentarAlbum> comentarAlbumList = comentarAlbumRepository.findAll();
//        assertThat(comentarAlbumList).hasSize(databaseSizeBeforeTest);
//    }
//
//    @Test
//    @Transactional
...
//            .andExpect(jsonPath("$.[*].albumName").value(hasItem(DEFAULT_ALBUM_NAME.toString())));
//    }
//
//    @Test
//    @Transactional
...
//            .andExpect(jsonPath("$.albumName").value(DEFAULT_ALBUM_NAME.toString()));
//    }
//
//    @Test
//    @Transactional
...
//        // Disconnect from session so that the updates on updatedComentarAlbum are not directly saved in db
//        em.detach(updatedComentarAlbum);
...
//        assertThat(testComentarAlbum.getAlbumName()).isEqualTo(UPDATED_ALBUM_NAME);
//    }
//
//    @Test
//    @Transactional
